...
public class NewTask extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setView(myLayout)
				.setTitle(R.string.DialogNewTaskTitle)
				...
				.setPositiveButton("Add",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								...
								Element ele = new Element(0, RowType.TASK_ROW.ordinal(), 0, priotity,
										TaskContent.getText().toString().replace("'", "''"), 0, 0);

								mListener.onDialogNewTask(ele);
							}
						})
				.setNegativeButton("Cancel",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								NewTask.this.getDialog().cancel();
							}
						});
